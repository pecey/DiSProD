...
class ContinuousDubinsCarAblation(gym.Env):
    metadata = {
        'render.modes': ['human'],
    }
    ...
    def __init__(self, alpha=0.0, add_obstacle=False, config_file=None, map_name="random"):
        ...
        self.min_angular_velocity = -60
        self.max_angular_velocity = 60
    ...
    def step(self, action):
        ...
        self.x, self.y, self.theta = self.update_state(self.x, self.y, self.theta, angular_velocity, linear_velocity**2, self.time_interval, noise)
    ...
    def update_state(self, x, y, theta, angular_velocity, velocity, time_interval, noise):
        ...
        dtheta_dt = (angular_velocity + noise * self.alpha) * self.time_interval * DEGREE_TO_RADIAN_MULTIPLIER
