...
base_run_name=${today}-online-learning
...
# Run experiments
jid1=$(sbatch --export=ALL,alg=${alg},base_run_name=${base_run_name},noise=False --parsable -o ${SLURM_LOG_PATH}/${identifier}_main.out  -e ${SLURM_LOG_PATH}/${identifier}_main.err ${HOME}/awesome-sogbofa/slurm_scripts/${system}/online_learning/${env_name}.sh)
