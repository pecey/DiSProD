...
env_name=continuous_dubins_car_ablation
n_sample=200
...
PYTHONPATH=. python run_gym.py --env_name ${env_name} --run_name ${run_name} --n_restarts=${n_sample} --n_episodes=10  --alpha=${alpha_val} --render=False --taylor_expansion_mode=${mode} --alg=sogbofa --map_name=cave-mini --step_size=0.2
